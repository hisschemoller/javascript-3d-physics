...
let mouseCoords = new Vector2(), raycaster = new Raycaster();
let wall, ball, ballObject;
...
function createBall(pos){
  ...
  //threeJS Section
  let ball = ballObject = new Mesh(new SphereBufferGeometry(radius), new MeshPhongMaterial({color: 0x05ff1e}));
...
function createWall(){
  ...
  //threeJS Section
  wall = new Mesh(new BoxBufferGeometry(), new MeshPhongMaterial({color: 0x42f5bf}));
  ...
  // const gridHelper = new GridHelper( 50, 50, 0x1111aa, 0xaa1111 );
  // scene.add( gridHelper );
  // gridHelper.rotateX( Math.degToRad(90));
